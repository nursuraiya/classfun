...
if (isset($_SESSION['id'])) {
   ...
   // Decrypt cookie variable value
    ...
    // Fetch records
    $stmt = $conn->prepare("SELECT count(*) as total FROM student WHERE id=:id");
    ...
    if (empty($email) || empty($pw)) {
        ...
        if ($result) {
            ...
            if ($pwCheck == false) {
                ...
                header("Location:dashboard.php?successid=".$id."&email=".urlencode($email));
                return;
            } else {
                $_SESSION["login_attempts"] += 1;
...
<body>
  <div class="right-banner">
    ...
    <form class="login-form" method="post">
      ...
      <div class="container">
        <img src="https://img.icons8.com/bubbles/2x/student-male.png" alt="student">
        ...
        if ($_SESSION["login_attempts"] > 2) {
            ...
            ?>
        <button type="submit" class="btn btn-primary" name="login-button">Enter</button>
        <?php
        } ?>
