...
$stmt = $conn->query("SELECT * FROM questionc order by qnum");
...
foreach ($row as $row) {
    ...
    echo '<a class="btn btn-warning" href="../edit/science.php? auto_id='.urlencode($row['auto_id']).'">Edit</a>';
    echo " ";
    echo '<a class="btn btn-danger" href="../delete/science.php? auto_id='.urlencode($row['auto_id']).'">Delete</a>';
    echo "\n";
    echo '</div>';
}
...
<a href="../add/science.php" class="btn btn-info" role="button">Add New Question</a>
