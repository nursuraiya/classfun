...
$stmt = $conn->query("SELECT * FROM questiond order by qnum");
...
foreach ($row as $row) {
    ...
    echo '<a class="btn btn-warning" href="../edit/english.php? auto_id='.urlencode($row['auto_id']).'">Edit</a>';
    echo " ";
    echo '<a class="btn btn-danger" href="../delete/english.php? auto_id='.urlencode($row['auto_id']).'">Delete</a>';
    echo "\n";
    echo '</div>';
}
...
echo '</form>';
?>
<a href="../add/english.php" class="btn btn-info" role="button">Add New Question</a>
