...
if (isset($_POST['question']) && isset($_POST['answer1']) && isset($_POST['qnum'])) {
    ...
    $sql_u = "SELECT * FROM questionc WHERE qnum='$qnumber'";
    ...
    if ((!is_numeric($_POST['qnum']))) {
        ...
        $sql = "INSERT INTO questionC (question, answer1, answer2, answer3, answer4, answer5, mark1, mark2, mark3, mark4, mark5, qnum)
  ...
  <div class="left">
    ...
    <form method="post">
      ...
      <p><input type="submit" class="btn btn-info" value="Add New" />
        <a class="btn btn-info" href="../questions/science.php">Cancel</a>
      </p>
    </form>
  </div>
</body>
