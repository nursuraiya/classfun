...
if (isset($_POST['delete']) && isset($_GET['auto_id'])) {
    $sql = "DELETE FROM questiona WHERE auto_id = :zip";
    echo "<pre>\n$sql\n</pre>\n";
...
<body>
  <div class="header">
    ...
    <p>Confirm: Question to Delete Question: <?= htmlentities($row['qnum']) ?></p>
      <form method="POST">
      <input type="submit" class="btn btn-danger"  value="Delete" name="delete" href="bm.php">
      <a href="../questions/bm.php" class="btn btn-info">Cancel</a>
      </form>
      </div>
